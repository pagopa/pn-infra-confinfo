...
vpc_endpoints_pn_confinfo = ["sqs","logs","sns","kms","kinesis-streams","elasticloadbalancing","events","ecr.api","ecr.dkr","ssmmessages","ssm","ec2messages","ecs-agent","ecs-telemetry","ecs","secretsmanager"]
...
vpc_pn_spid_hub_aws_services_interface_endpoints_subnets_cidr = ["10.3.90.0/24","10.3.91.0/24","10.3.92.0/24"]
vpc_endpoints_pn_spid_hub = ["sqs","logs","sns","kms","kinesis-streams","elasticloadbalancing","events","ecr.api","ecr.dkr","ssmmessages","ssm","ec2messages","ecs-agent","ecs-telemetry","ecs"]

vpc_pn_spid_hub_private_subnets_cidr = ["10.3.10.0/24","10.3.11.0/24","10.3.12.0/24"]
...
vpc_pn_spid_hub_public_subnets_cidr = ["10.3.1.0/28","10.3.1.16/28","10.3.1.32/28"]
...
vpc_pn_spid_hub_internal_subnets_cidr = ["10.3.90.0/24","10.3.91.0/24","10.3.92.0/24"]
vpc_pn_spid_hub_internal_subnets_names = ["PN SpidHub - AWS Services Subnet (dev) AZ 0","PN SpidHub - AWS Services Subnet (dev) AZ 1","PN SpidHub - AWS Services Subnet (dev) AZ 2"]
