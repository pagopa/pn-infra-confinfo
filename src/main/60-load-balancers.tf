...
resource "aws_lb" "pn_confinfo_dvin_nlb" {
  ...
  tags = {
    ...
    "pn-eni-related": "true",
    "pn-eni-related-groupName-regexp": base64encode("^ELB net/DvI-.*$")
  }
}
...
resource "aws_lb" "pn_confinfo_ecssin_nlb" {
  ...
  tags = {
    ...
    "pn-eni-related": "true",
    "pn-eni-related-groupName-regexp": base64encode("^ELB net/EcssI-.*$")
  }
}
...
resource "aws_lb" "pn_confinfo_postel_nlb" {
  ...
  tags = {
    ...
    "pn-eni-related": "true",
    "pn-eni-related-groupName-regexp": base64encode("^ELB net/PtI-.*$")
  }
}
